...
namespace xna {
    ...
    GameRunBehavior SDLGamePlatform::DefaultRunBehavior() {
        return GameRunBehavior::Synchronous;
    }

    void SDLGamePlatform::BeforeInitialize() {
        // SdlRunLoop();
        GamePlatform::BeforeInitialize();
    }

    void SDLGamePlatform::OnIsMouseVisibleChanged() {
            // _view.SetCursorVisible(_game.IsMouseVisible);
    }

    void SDLGamePlatform::OnPresentationChanged() {
    ...
    bool SDLGamePlatform::BeforeRun()
    {
    ...
    void SDLGamePlatform::SdlRunLoop()
    {
        // Sdl.Event ev;
    ...
    void SDLGamePlatform::StartRunLoop() {
            // throw new Exception.NotSupportedException("The desktop platform does not support asynchronous run loops");
    }

    void SDLGamePlatform::Exit(){
        mIsExiting++;
    }

    bool SDLGamePlatform::BeforeUpdate(){
        return true;
    }

    bool SDLGamePlatform::BeforeDraw(){
        return true;
    }

    void SDLGamePlatform::EnterFullScreen()
    {
    }

    void SDLGamePlatform::ExitFullScreen()
    {
    }

    void SDLGamePlatform::BeginScreenDeviceChange (
                bool willBeFullScreen
    ) {}

    void SDLGamePlatform::EndScreenDeviceChange (
    ...
    void SDLGamePlatform::Log(char* Message) {}		
